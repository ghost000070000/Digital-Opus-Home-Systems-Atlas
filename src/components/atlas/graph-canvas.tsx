...
function visibleEntities(doc: AtlasDocument, roomFilter: string[], systemFilter: string[]): Entity[] {
...
function buildScene(
  ...
  const vis = visibleEntities(doc, roomFilter, systemFilter);
...
export function GraphCanvas() {
  ...
  const scene = useMemo(
    ...
    [doc, ui.collapsedRoomIds, ui.hiddenRelationTypes, ui.roomFilter, ui.systemFilter],
  );
