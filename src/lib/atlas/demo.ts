...
export function willowHouseDemo(): AtlasDocument {
  ...
  doc.rooms = [
    createRoom({ id: R.living, name: "Living Room", notes: "TV wall, seating, console cabinet." }),
    createRoom({ id: R.office, name: "Home Office", notes: "Standing desk, two monitors, docking station." }),
    createRoom({ id: R.closet, name: "Server Closet", notes: "12U rack, patch panel, UPS. Door stays closed." }),
    createRoom({ id: R.kitchen, name: "Kitchen", notes: "Counter tablet and a few smart plugs." }),
    createRoom({ id: R.garage, name: "Garage", notes: "Furnace, opener, driveway camera homerun." }),
    createRoom({ id: R.bedroom, name: "Bedroom", notes: "Mesh AP and thermostat." }),
    createRoom({ id: R.workshop, name: "Workshop", notes: "Bench PC and 3D printer." }),
  ];
  ...
  doc.relationships = [
    ...
    rel("rel_thermo_furnace", "ent_thermo", "custom", "ent_furnace", "Thermostat commands the furnace."),
